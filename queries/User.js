...
const getUser = async (id) => {
  try {
    const oneUser = await db.any('SELECT * FROM user WHERE id = $1', id);
    return oneUser;
  } catch (error) {
