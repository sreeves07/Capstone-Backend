...
//Update
const updateUser = async (id, fashion) => {
  try {
    const updatedUser = await db.one(
      'UPDATE mate SET First_Name=$1, Last_Name=$2, Password=$3, Age=$4, Email=$5, City=$6, State=$7, Birthday=$8, Gender=$9, Orientation=$10, Has_Pets=$11, Has_Open_Rooms=$12, Is_Smoker=$13, Has_Kids=$14, Is_Disabled=$15, Is_Sharing_bills=$16, Is_Neat=$17, Is_Religious=$18, Move_In_Date=$19, Max_Rent=$20, Credit_Score=$21, Income=$22 WHERE id=$23 RETURNING *',
      [
        fashion.name,
        fashion.price,
        fashion.img_url,
